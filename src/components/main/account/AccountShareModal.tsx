            ...
            <div className="left-pane">
              ...
              <div className="permissions">
                ...
                <div className="permissions-prompt">
                  This person can do the following with my documents...
                </div>
                ...
                {searchedDocuments.map((searchedDocument, idx) => (
                  <div key={idx} className="document-item">
                    ...
                    <div className="doc-share">
                      ...
                      {/* TODO: needs to be 3 toggles */}
                      {/* <Checkbox
                        onClick={() =>
                          this.handleShareDocWithContact(searchedDocument, permissions)
                        }
                        isChecked={
                          !!this.getDocumentSharedWithContact(searchedDocument)
                        }
                      /> */}
                    </div>
                  </div>
