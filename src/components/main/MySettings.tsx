      ...
      <Fragment>
        ...
        >
          <ModalHeader toggle={() => setOpen(!isOpen)} close={closeBtn}>
            ...
            <div>{AccountImpl.displayName(this.props.account)}</div>
          </ModalHeader>
          <ModalBody>
            ...
            {activeOption === 1 && (
              <div className="account-settings-content">
                ...
                <div className="account-content-excerpt">
                  To change your password, security questions, phone number, set
                  a private key, delete biometrics data or re-configure any of
                  your login methods, click the link below...
                </div>
                <Button
