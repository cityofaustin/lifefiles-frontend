...
class App extends Component<{}, AppState> {
  ...
  async componentDidMount(): Promise<void> {
    ...
    if (process.env.REACT_APP_LIFEFILES_API === undefined) {
      ...
      ApiService.setApiEndpoint(process.env.REACT_APP_LIFEFILES_API);
    }
    if (process.env.REACT_APP_AUTH_API === undefined) {
      const response = await AccountService.getOauthEndpoint();
      AccountService.setAuthApi(response.url);
    } else {
      AccountService.setAuthApi(process.env.REACT_APP_AUTH_API);
    }
